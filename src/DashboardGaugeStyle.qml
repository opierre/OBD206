...
CircularGaugeStyle {
    tickmarkInset: toPixels(0.10)
    minorTickmarkInset: tickmarkInset * 1.75
    labelStepSize: 20
    labelInset: -toPixels(0.10)
    ...
    function paintBackground(ctx) {
        ...
        ctx.arc(xCenter, yCenter, outerRadius/2 - ctx.lineWidth / 2, outerRadius - ctx.lineWidth / 1, 0, Math.PI * 2);
        ctx.stroke();
